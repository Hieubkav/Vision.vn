            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div class="space-y-8">
                    @foreach ($cart->cart_items as $cart_item)
                        <div
                            class="flex items-start p-6 bg-white border rounded-lg shadow-lg transition-transform transform hover:scale-105">
                            <img src="{{ asset('asset/all_pic/') }}/{{ $cart_item->colorversionsize->color_version_image->image }}"
                                alt="ảnh sản phẩm trong giỏ" class="w-1/4 rounded-lg shadow-inner mr-8">
                            <div class="flex-1">
