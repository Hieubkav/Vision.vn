    ...
    <banner_two>
        <div class="max-w-screen-lg mx-auto p-6">
            <div class="bg-white shadow-xl rounded-lg overflow-hidden border border-gray-200">
                <div class="relative">
                    <img src="{{asset('asset/all_pic')}}/{{$setting->banner_two_pic}}"
                        alt="Mắt Kính" class="w-full h-96 object-cover">

                    <div class="absolute inset-0 bg-gradient-to-t from-black to-transparent p-6">
                        <div class="absolute bottom-0 left-0 pb-8 pl-8">
                            <h2 class="text-4xl font-semibold text-white leading-tight mb-3">{{$setting->banner_two_big_text}}</h2>
