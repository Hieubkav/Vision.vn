...
@section('content')
    <div class="container mx-auto p-6 flex flex-col md:flex-row">
        ...
        <aside class="w-full md:w-1/4 pr-4 mb-6 md:mb-0">
                ...
                <div class="relative hover:bg-gray-100 p-2 rounded">
                    ...
                    <select name="category" id="category"
                        ...
                        @foreach ($categories as $item)
                            <option @php
if ($category==str($item->id) ) echo "selected"; @endphp
                                value="{{ $item->id }}">
                                {{ $item->name }}
                            </option>
                        @endforeach
                ...
                <div class="relative hover:bg-gray-100 p-2 rounded">
                    ...
                    <select name="brand" id="brand"
                        ...
                        @foreach ($brands as $item)
                            <option @php
if ($brand==str($item->id) ) echo "selected"; @endphp value="{{ $item->id }}">
                                {{ $item->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="relative hover:bg-gray-100 p-2 rounded">
                    ...
                    <select name="material" id="material"
                        ...
                        @foreach ($materials as $item)
                            <option @php
if ($material==str($item->id) ) echo "selected"; @endphp
                ...
                <div class="relative hover:bg-gray-100 p-2 rounded">
                    ...
                    <select name="design" id="design"
                        ...
                        @foreach ($designs as $item)
                            <option @php
if ($design==str($item->id) ) echo "selected"; @endphp value="{{ $item->id }}">
                                {{ $item->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="relative hover:bg-gray-100 p-2 rounded">
                    ...
                    <select name="shape" id="shape"
                        ...
                        @foreach ($shapes as $item)
                            <option @php
if ($shape==str($item->id) ) echo "selected"; @endphp value="{{ $item->id }}">
                                {{ $item->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="relative hover:bg-gray-100 p-2 rounded">
                    ...
                    <select name="source" id="source"
                        ...
                        @foreach ($sources as $item)
                            <option @php
if ($source==str($item->id) ) echo "selected"; @endphp
                                value="{{ $item->id }}">{{ $item->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="relative hover:bg-gray-100 p-2 rounded">
                    ...
                    <select name="color" id="color"
                        ...
                        @foreach ($colors as $item)
                            <option @php
if ($color==str($item->id) ) echo "selected"; @endphp
                                value="{{ $item->id }}">
                                {{ $item->name }}
                            </option>
                        @endforeach
                ...
                <div class="relative hover:bg-gray-100 p-2 rounded">
                    ...
                    <select name="size" id="size"
                        ...
                        @foreach ($sizes as $item)
                            <option @php
if ($size==str($item->id) ) echo "selected"; @endphp
                                value="{{ $item->id }}">
                                {{ $item->name }}
                            </option>
                        @endforeach
