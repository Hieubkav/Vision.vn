        ...
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-4 relative">
                <button class="text-gray-700 hover:underline"
                    onclick="toggleMenu(document.getElementById('menu_danhmuc'), this)">
                    Danh mục
                    @php
                ...
                <button class="text-gray-700 hover:underline"
                    onclick="toggleMenu(document.getElementById('menu_gioitinh'), this)">
                    Giới tính
    ...
    <div id="middle-links-modal"
        ...
        <div
            ...
            <div class="space-y-5">
                ...
                <a href=""
                    class="block text-center font-semibold text-gray-800 hover:text-gray-900 transition-colors duration-300">Thương
                    hiệu</a>
                <a href=""
                    class="block text-center font-semibold text-gray-800 hover:text-gray-900 transition-colors duration-300">Chính
                    sách</a>
            </div>
    ...
    <footer class="bg-gray-800 text-white mt-12 py-10 shadow-md">
        <div
            ...
            <div class="text-center">
                ...
                <ul class="space-y-2">
                    <li><a href="{{route('page_user',4)}}" class="text-gray-400 hover:text-white transition-colors duration-300">Liên
                            hệ</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-300">Chính
                            sách</a></li>
                    <li><a href="{{route('page_user',6)}}" class="text-gray-400 hover:text-white transition-colors duration-300">Quyền
                            lợi</a></li>
                    <li><a href="{{route('page_user',7)}}" class="text-gray-400 hover:text-white transition-colors duration-300">Thời
                            gian giao hàng?</a></li>
                </ul>
            </div>
            <div class="text-center">
                ...
                <ul class="space-y-2">
                    <li><a href="{{route('page_user',8)}}" class="text-blue-400 hover:text-blue-300 transition-colors duration-300">Làm
                    ...
                    <li><a href="{{route('page_user',11)}}" class="text-blue-400 hover:text-blue-300 transition-colors duration-300">Phí
